package test.java.ua.nure.loboda.gui;
...
import main.java.ua.nure.loboda.gui.MainFrame;
...
public class MainFrameTest extends JFCTestCase {
    private static final String firstName = "Stas";
    private static final String lastName = "loboda";
